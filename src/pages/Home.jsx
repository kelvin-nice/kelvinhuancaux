...
/* tecnologias ux ui */
import logoFigma from '../assets/ux-technologies/figma.svg'
import logoMaze from '../assets/ux-technologies/maze.svg'
import logoNotion from '../assets/ux-technologies/notion.svg'
import logoHojtar from '../assets/ux-technologies/hojtar.svg'
import logoInvision from '../assets/ux-technologies/invision.svg'
import logoMiro from '../assets/ux-technologies/miro.svg'
import logoSketch from '../assets/ux-technologies/sketch.svg'
import logoZeplin from '../assets/ux-technologies/zeplin.svg'

/* tecnologias frontend */
import logoHtml from '../assets/frontend-technologies/html.svg'
import logoCss from '../assets/frontend-technologies/css.svg'
import logoSass from '../assets/frontend-technologies/sass.svg'
import logoTailwind from '../assets/frontend-technologies/tailwind.svg'
import logoWordpress from '../assets/frontend-technologies/wordpress.svg'
import logoJs from '../assets/frontend-technologies/js.svg'
import logoReact from '../assets/frontend-technologies/react.svg'
     ...
     <section>
      <div className='contenedor-tres' >
        ...
        <div className='table-home' >
          <div className='table-ux' >
            <h3>UX / UI</h3>
            {/* <img src={uxui} className='uxui' alt="uxui" /> */}
            <div className='technologies-ux' >
              <div className='tooltip-container' >
                <img src={logoFigma} alt="logo figma" width={73} height={75}/>
                <span className='tooltip' >Figma</span>
              </div>
              <div className='tooltip-container' >
                <img src={logoSketch} alt="logo sketch" width={73} height={75}/>
                <span className='tooltip' >Sketch</span>
              </div>
              <div className='tooltip-container' >
                <img src={logoMaze} alt="logo maze" width={73} height={75}/>
                <span className='tooltip' >Maze</span>
              </div>
              <div className='tooltip-container' >
                <img src={logoHojtar} alt="logo hojtar" width={73} height={75}/>
                <span className='tooltip' >Hojtar</span>
              </div>
              <div className='tooltip-container' >
              <img src={logoNotion} alt="logo notion" width={73} height={75}/>
                <span className='tooltip' >Notion</span>
              </div>
              <div className='tooltip-container' >
                <img src={logoMiro} alt="logo miro" width={73} height={75}/>
                <span className='tooltip' >Miro</span>
              </div>
              <div className='tooltip-container' >
              <img src={logoInvision} alt="logo invision" width={73} height={75}/>
                <span className='tooltip' >Invision</span>
              </div>
              <div className='tooltip-container' >
              <img src={logoZeplin} alt="logo zeplin" width={73} height={75}/>
                <span className='tooltip' >Zeplin</span>
              </div>
          ...
          <div className='table-front' >
            <h3>Frontend</h3>
            <div className='technologies-front'>
              <div className='tooltip-container' >
              <img src={logoHtml} alt="logo html" width={73} height={75}/>
                <span className='tooltip' >HTML</span>
              </div>
              <div className='tooltip-container' >
              <img src={logoCss} alt="logo css" width={73} height={75}/>
                <span className='tooltip' >Css</span>
              </div>
              <div className='tooltip-container' >
              <img src={logoSass} alt="logo sass" width={73} height={75}/>
                <span className='tooltip' >Sass</span>
              </div>
              <div className='tooltip-container' >
              <img src={logoTailwind} alt="logo tailwind" width={73} height={75}/>
                <span className='tooltip' >Tailwind</span>
              </div>
              <div className='tooltip-container' >
              <img src={logoWordpress} alt="logo wordpress" width={73} height={75}/>
                <span className='tooltip' >Wordpress</span>
              </div>
              <div className='tooltip-container' >
              <img src={logoJs} alt="logo js" width={73} height={75}/>
                <span className='tooltip' >Javascript</span>
              </div>
              <div className='tooltip-container' >
              <img src={logoReact} alt="logo react" width={73} height={75}/>
